				...
				<Navbar.Collapse id="basic-navbar-nav">
					<Nav className="mr-auto">
						...
						<NavDropdown title="TV Shows" id="basic-nav-dropdown">
							<NavDropdown.Item as={Link} to="/popular-tv-shows">Popular</NavDropdown.Item>
							<NavDropdown.Item as={Link} to="/airing-today-tv-shows">Airing Today</NavDropdown.Item>
							<NavDropdown.Item as={Link} to="/on-the-air-tv-shows">On TV</NavDropdown.Item>
							<NavDropdown.Item as={Link} to="/top-rated-tv-shows">Top Rated</NavDropdown.Item>
						</NavDropdown>
					</Nav>
					<Form inline>
